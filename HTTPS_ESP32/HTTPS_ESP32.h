...
{
public:
  HTTPS_ESP32(String _linkpost, String _linkget, String _LinkServerpost, String _LinkServerpget);
  String HTTPS_GET(String data);
  String HTTPS_POST(String data);

private:
  String LinkServerpost;
  String LinkServerget;
  String linkpost;
  String linkget;
